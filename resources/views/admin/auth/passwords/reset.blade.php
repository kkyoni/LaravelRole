...
<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
    <div class="col-xs-12">
        {!! Form::email('email',$passwordReset->email !== null ? $passwordReset->email : old('email'),['class' => "form-control ",'placeholder' => "Email Address",'required','autofocus'])!!}
...
<div class="form-group">
    <div class="col-xs-12">
        {!! Form::password('password_confirmation',['class' => 'form-control','placeholder' => 'Confirm Password','required','id'    => 'password-confirm']) !!}
    </div>
</div>
