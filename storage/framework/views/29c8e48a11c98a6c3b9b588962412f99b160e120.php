...
<div class="bgimg">
  <div class="topleft">
    <p><img src="<?php echo e(url(\Settings::get('application_logo'))); ?>" style="height:60px;width:60px;"></p>
  </div>
  <div class="middle">
    <h1>COMING SOON</h1>
  </div>
...
</html><?php /**PATH /var/www/html/particle_role/resources/views/home.blade.php ENDPATH**/ ?>