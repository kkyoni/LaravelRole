...
<style type="text/css">
.ibox-content{width: 350px;height: auto;top: 150px;position: absolute;}
</style>
<div class="row">
	<div class="col-md-12">
		...
		<div class="ibox-content ibox-content_login">
			<img src="<?php echo e(url(\Settings::get('application_logo'))); ?>" style="height: 60px;width: 60px;">
			<h2 class="font-bold">Admin Login</h2>
			<div class="row">
				<div class="col-lg-12">
					<h3>Welcome to <?php echo e(Settings::get('application_title')); ?></h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.appAuth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/particle_role/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>